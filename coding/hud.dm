		...
		UpdateHUD(mob/M)
			...
			for(var/screen/number/O in M.client.screen)
				if(O._x == 11) //hunger
					...
					O.icon_state = "[copytext("[P ? P.GetVariable("score_deaths") : -1]",O.pposition,O.pposition+1)]"
				else if(O._x == "9:24" && O._y == "-1:24") //taxes
					O.icon_state = "[copytext("[P ? P.GetVariable("score_taxes") : -1]",O.pposition,O.pposition+1)]"
				else if(O._x == "2:24" && O._y == "-1") //royalty
					O.icon_state = "[copytext("[P ? P.GetVariable("score_royalblood") : -1]",O.pposition,O.pposition+1)]"
				else if(O._x == "9:24" && O._y == "-1") //rpp
					O.icon_state = "[copytext("[P ? P.GetVariable("score_rppoints") : -1]",O.pposition,O.pposition+1)]"
